...
func (mc *MessageConverter) convertMediaMessage(
	...
	if mc.DirectMedia {
		...
		preparedMedia.URL, err = portal.Bridge.Matrix.GenerateContentURI(ctx, waid.MakeMediaIDWithVersion(messageInfo, idOverride, portal.Receiver, getMediaIDVersion(msg)))
		if err != nil {
